module.exports = function(str) {
  ...
  for(;pos < str.length;) switch(state) {
    ...
    case 36:
      ...
      if(str.startsWith('Z', cur)) return true;
      pos++; cur = pos; continue;
    case 37:
    ...
    case 48:
      ...
      if(str.startsWith('マルド', cur)) return true;
      pos++; cur = pos; continue;
    case 49:
      if(str.startsWith('', cur)) return true;
    ...
    case 52:
      ...
      if(str.startsWith('ーナイト', cur)) return true;
    ...
    case 59:
      ...
      pos++; cur = pos; continue;
    case 60:
      if(str.startsWith('ナ', cur)) return true;
    ...
    case 62:
      ...
      if(str.startsWith('トノ', cur)) return true;
      pos++; cur = pos; continue;
    case 63:
    ...
    case 117:
      ...
      if(str.startsWith('ペッタ', cur)) return true;
      pos++; cur = pos; continue;
    case 118:
    ...
    case 157:
      ...
      pos++; cur = pos; continue;
    case 158:
      if(str.startsWith('オン', cur)) return true;
      if(str.startsWith('ガー', cur)) return true;
      pos++; cur = pos; continue;
    case 159:
    ...
    case 163:
      ...
      if(str.startsWith('ーマンダ', cur)) return true;
      pos++; cur = pos; continue;
